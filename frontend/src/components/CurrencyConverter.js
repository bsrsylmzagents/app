  ...
  return (
    <div className="relative z-[10001]" ref={dropdownRef}>
      <div className="flex items-center gap-3">
        {isDynamicTheme ? (
          <>
            {/* Dynamic Theme: Transparent pill style */}
            <button
            ...
            {/* Currency Rates - White text, embedded style */}
      ...
      {showConverter && (
        <div 
          className={`absolute left-0 top-full mt-2 w-80 rounded-xl shadow-2xl p-4 z-[10002] ${
            isDynamicTheme 
              ? 'bg-white' 
              : ''
          }`}
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onFocus={!isDynamicTheme ? (e) => e.target.style.borderColor = 'var(--accent)' : undefined}
                onBlur={!isDynamicTheme ? (e) => e.target.style.borderColor = 'var(--border)' : undefined}
