        ...
        <div className="w-full max-w-md flex-1 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              {/* Demo Request Link - FORCED ORANGE FIX */}
              <div className="mt-8 text-center">
                <p className="text-sm text-gray-900 font-normal" style={{ fontFamily: 'Inter, sans-serif' }}>
                  ...
                  <button
                    ...
                    className="font-bold hover:underline cursor-pointer transition-colors focus:outline-none bg-transparent border-none p-0"
                    style={{ fontFamily: 'Inter, sans-serif' }}
                  >
                    {/* Inline Style on Span overrides EVERYTHING */}
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
              <span className="text-orange-500 font-semibold">Demo talebinizi gönderin</span>, size en kısa sürede dönüş yapalım.
            </DialogDescription>
          </DialogHeader>
